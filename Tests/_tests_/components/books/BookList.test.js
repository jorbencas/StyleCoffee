...
import ConnectedBooksListPage  from '../../../../src/Client/Components/Books/BooksListPage';
import ConnectedShoppingCard from '../../../../src/Client/Components/Card/ShoppingCard';
...
it('render component booklist with one book', () => {
    const store = mockStore({ productsList: {books: book}});
    const wrapper = render(<ConnectedBooksListPage store={store}/>)
